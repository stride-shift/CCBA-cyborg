-- Enhance cohorts table with all missing columns and fix user_profiles relationship (FIXED)
...
-- Step 3: Update existing cohorts with reasonable defaults (FIXED calculation)
UPDATE cohorts SET 
    status = 'active',
    max_participants = 25,

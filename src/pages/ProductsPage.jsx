        ...
        <div className="mb-20">
          ...
          <div className="mb-12 md:mb-16 relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              ...
              <div className="absolute left-[10%] top-1/2 w-3 h-3 rounded-full bg-white/30 transform -translate-y-1/2"></div>
              <div className="absolute right-[10%] top-1/2 w-3 h-3 rounded-full bg-white/30 transform -translate-y-1/2"></div>
            </div>

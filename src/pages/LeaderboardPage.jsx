...
function LeaderboardPage() {
  ...
  const loadLeaderboard = async (cohortId) => {
    try {
      ...
      try {
        ...
        console.warn(
          "get_enhanced_cohort_leaderboard_v2 unavailable, falling back:",
          e?.message || e,
        );
      ...
      console.log(
        "🏆 Enhanced leaderboard data loaded:",
        fetched.length,
        "users",
      );
  ...
  const getRankBadgeColor = (rank) => {
    if (rank === 1)
      return "bg-gradient-to-br from-amber-200/30 to-yellow-300/40 text-amber-800 shadow-lg border-amber-200/50 backdrop-blur-sm";
    if (rank === 2)
      return "bg-gradient-to-br from-slate-200/30 to-gray-300/40 text-slate-800 shadow-lg border-slate-200/50 backdrop-blur-sm";
    if (rank === 3)
      return "bg-gradient-to-br from-orange-200/30 to-amber-300/40 text-orange-800 shadow-lg border-orange-200/50 backdrop-blur-sm";
    if (rank === 4)
      return "bg-gradient-to-br from-purple-200/30 to-indigo-300/40 text-purple-800 shadow-lg border-purple-200/50 backdrop-blur-sm";
  ...
  const getCurrentUserRank = () => {
    ...
    const userEntry = leaderboardData.find(
      (entry) =>
        entry.user_id === profile.user_id || entry.id === profile.user_id,
    );
  ...
  const getCurrentUserFullEntry = () => {
    ...
    return (
      fullLeaderboardData.find((e) => e.user_id === profile.user_id) || null
    );
  };
          ...
          {leaderboardData.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-black/70 text-lg">
                No participants found in this cohort yet.
              </p>
            ...
            <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap items-center gap-4 md:gap-6 text-sm text-black/70">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">
                              {user.total_reflections_submitted}
                            </span>
                    ...
                    <div className="md:text-right">
                      <div className="mb-2 md:mb-4">
                        <div className="text-2xl md:text-3xl font-bold text-black mb-2">
                          {Math.round(
                            parseFloat(user.journey_completion_percentage),
                          )}
                          %
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      ...
                      <div className="flex items-center gap-4 md:gap-6">
                        ...
                        <div>
                          <div className="flex items-center gap-3 mb-2">
                            <h3 className="text-lg md:text-xl font-semibold text-black">
                              {leaderboardData[3].first_name}{" "}
                              {leaderboardData[3].last_name}
                            </h3>
                            {leaderboardData[3].user_id ===
                              profile?.user_id && (
                              <span className="px-3 py-1 bg-blue-500/20 text-blue-700 text-xs font-medium rounded-full border border-blue-500/30">
                                You
                              </span>
                          ...
                          <div className="flex flex-wrap items-center gap-4 md:gap-6 text-sm text-black/70">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium">
                                {leaderboardData[3].total_days_completed}
                              </span>
                              <span>days</span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium">
                                {leaderboardData[3].total_challenges_completed}
                              </span>
                              <span>challenges</span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium">
                                {leaderboardData[3].total_reflections_submitted}
                              </span>
                              <span>reflections</span>
                            </div>
                            {leaderboardData[3].current_streak_days > 0 && (
                              <div className="flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-orange-200/30 to-amber-200/40 rounded-full border border-orange-200/50 backdrop-blur-sm">
                                ...
                                <span className="font-bold text-orange-700">
                                  {leaderboardData[3].current_streak_days}
                                </span>
                                <span className="text-orange-600 text-xs">
                                  streak
                                </span>
                        ...
                        <div className="mb-2 md:mb-4">
                          ...
                          <div className="w-full md:w-32 h-3 bg-white/20 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${Math.min(parseFloat(leaderboardData[3].journey_completion_percentage), 100)}%`,
                              }}
                            ></div>
                          </div>
                        </div>
              ...
              {(() => {
                ...
                const inTop4 = leaderboardData.some(
                ...
                return (
                  <div className="mt-6">
                    <div
                      className={`relative p-4 md:p-6 glassmorphism rounded-xl border transition-all duration-300 hover:scale-[1.02] hover:shadow-lg border-blue-400/40 bg-blue-500/10`}
                    >
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div className="flex items-center gap-4 md:gap-6">
                          <div
                            className={`relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full border-2 text-xl font-bold ${getRankBadgeColor(me.rank_position)}`}
                          >
                            <span className="relative z-10">
                              {getRankIcon(me.rank_position)}
                            </span>
                          </div>
                          <div>
                            <div className="flex items-center gap-3 mb-2">
                            ...
                            <div className="flex flex-wrap items-center gap-4 md:gap-6 text-sm text-black/70">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="font-medium">
                                  {me.total_reflections_submitted}
                                </span>
                                <span>reflections</span>
                              </div>
                        ...
                        <div className="md:text-right">
                          <div className="mb-2 md:mb-4">
                            <div className="text-2xl md:text-3xl font-bold text-black mb-2">
                              {Math.round(
                                parseFloat(me.journey_completion_percentage),
                              )}
                              %
                            </div>
                            <div className="w-full md:w-32 h-3 bg-white/20 rounded-full overflow-hidden">
                          ...
                          <div className="text-xs text-black/60 bg-white/10 px-2 py-1 rounded-full inline-block">
                            {me.surveys_completed}/2 surveys
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="mt-10 md:mt-12 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full border border-white/20">
              <span className="text-sm text-black/60">
                Showing top 3 performers and honorable mention • Rankings update
                in real-time
              </span>
            </div>
          </div>

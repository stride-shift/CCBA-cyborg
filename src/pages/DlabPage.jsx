      ...
      <Link key={dayNumber} to={`/day/${dayNumber}`} className="snap-start flex-shrink-0">
        ...
        `}>
          ...
          <div className="text-center">
            <span className={`font-bold text-white ${isSurveyDay ? 'text-5xl' : 'text-7xl'}`}>{dayNumber}</span>
            {isSurveyDay && (
              <div className="mt-2">
                <p className="text-white text-sm font-medium">{isPreSurvey ? 'Pre-Program' : 'Post-Program'}</p>
                <p className="text-white/80 text-xs">Survey Day</p>
              </div>
            )}
          </div>
          {isCompleted && (
  ...
  return (
    <Layout>
      <div className="container mx-auto px-6 py-16">
        {/* 1) Video */}
        <div className="mb-20">
          <h1 className="text-5xl md:text-6xl font-bold text-center mb-12 text-white">Watch this video to get started</h1>
          <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-2xl glassmorphism">
            ...
            {introVideo && (
              <div className="p-4 bg-white/10 backdrop-blur-sm">
                ...
                {introVideo.description && <p className="text-white/80 text-sm">{introVideo.description}</p>}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="mb-20">
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-white">Your Journey</h2>
          </div>
          ...
          <div className="glassmorphism rounded-2xl p-8">
            ...
            <div className="flex justify-between items-center">
              <span className="text-lg text-white/80">{completedDays.size}/{totalDaysWithSurveys} days completed (includes surveys)</span>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="glassmorphism rounded-2xl p-6 h-56 relative flex items-center justify-center">
            <div className="absolute top-4 left-4 text-xs px-3 py-1 rounded-full bg-blue-500/80 text-white">SURVEY</div>
            <div className="text-center">
              <div className="text-white text-8xl font-bold">0</div>
              <div className="mt-2">
                <div className="text-white text-3xl font-bold">Pre-Program</div>
                <div className="text-white/80 text-xl">Survey</div>
              </div>
            </div>
          ...
          <div className="glassmorphism rounded-2xl p-6 h-56 relative flex items-center justify-center">
            <div className="absolute top-4 left-4 text-xs px-3 py-1 rounded-full bg-blue-500/80 text-white">SURVEY</div>
            <div className="text-center">
              <div className="text-white text-8xl font-bold">1</div>
              <div className="mt-2">
                <div className="text-white text-3xl font-bold">Post-Program</div>
                <div className="text-white/80 text-xl">Survey</div>
              </div>
            </div>
          </div>
          ...
          <div className="glassmorphism rounded-2xl p-6 h-56 relative flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="text-white text-4xl font-bold">Launch</div>
            </div>
          </div>
          ...
          <div className="glassmorphism rounded-2xl p-6 h-56 relative flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="text-white text-4xl font-bold">Orbit</div>
            </div>
          </div>
        </div>
      </div>
